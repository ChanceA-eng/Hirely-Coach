      ...
      <div style={S.inner}>
        ...
        {(pageStatus === "idle" || pageStatus === "error") && (
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
            ...
            style={{ ...S.dropZone, borderColor: dragging ? "#10b981" : "rgba(148,163,184,0.24)", backgroundColor: dragging ? "rgba(16,185,129,0.08)" : "rgba(15,23,42,0.62)" }}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth={1.4} strokeLinecap="round" style={{ margin: "0 auto 12px", display: "block" }}>
        ...
        {pageStatus === "saving" && (
          <div style={{ textAlign: "center", padding: "48px" }}>
            <div style={S.spinner} />
            <p style={{ color: "#94a3b8", margin: "16px 0 0", fontSize: "0.88rem" }}>Seeding database…</p>
          </div>
        )}
        ...
        {pageStatus === "done" && result && (
          <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} style={{ ...S.card, textAlign: "center" }}>
            ...
            <h2 style={{ margin: "0 0 8px", fontWeight: 700, color: "#f8fafc" }}>Database Updated</h2>
...
const S: Record<string, React.CSSProperties> = {
  page: { minHeight: "100vh", background: "transparent", padding: "0 0 24px", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", color: "#f8fafc" },
  ...
  badge: { display: "inline-block", background: "rgba(16,185,129,0.12)", color: "#6ee7b7", border: "1px solid rgba(16,185,129,0.28)", borderRadius: 20, padding: "3px 12px", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", marginBottom: 10 },
  title: { fontSize: "1.75rem", fontWeight: 800, margin: "0 0 6px", color: "#f8fafc" },
  sub: { color: "#94a3b8", fontSize: "0.88rem", margin: 0 },
  statsBox: { background: "rgba(15,23,42,0.62)", border: "1px solid rgba(148,163,184,0.24)", borderRadius: 12, padding: "20px 28px", textAlign: "center", minWidth: 160 },
  statsNum: { margin: "0 0 2px", fontSize: "2rem", fontWeight: 800, color: "#f8fafc" },
  statsLabel: { margin: "0 0 12px", color: "#94a3b8", fontSize: "0.8rem" },
  dangerBtn: { background: "transparent", border: "1px solid rgba(248,113,113,0.28)", color: "#fca5a5", borderRadius: 8, padding: "8px 14px", fontSize: "0.8rem", fontWeight: 600, fontFamily: "inherit" },
  dropZone: { border: "2px dashed rgba(148,163,184,0.24)", borderRadius: 16, padding: "52px 24px", textAlign: "center", cursor: "pointer", transition: "all 0.2s", marginBottom: 12 },
  uploadChip: { background: "#10b981", color: "#052e16", borderRadius: 8, padding: "8px 18px", fontSize: "0.83rem", fontWeight: 700 },
  hintBox: { display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap", marginBottom: 20 },
  codeChip: { background: "rgba(255,255,255,0.06)", color: "#e2e8f0", border: "1px solid rgba(148,163,184,0.18)", borderRadius: 4, padding: "1px 7px", fontSize: "0.78rem", fontFamily: "monospace" },
  errorBox: { background: "rgba(127,29,29,0.3)", border: "1px solid rgba(248,113,113,0.28)", borderRadius: 12, padding: "16px 20px", color: "#fecaca", fontSize: "0.88rem", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 },
  linkBtn: { background: "transparent", border: "none", color: "#e2e8f0", textDecoration: "underline", cursor: "pointer", fontSize: "0.85rem", fontFamily: "inherit", flexShrink: 0 },
  card: { background: "rgba(15,23,42,0.62)", border: "1px solid rgba(148,163,184,0.24)", borderRadius: 16, padding: "32px", boxShadow: "0 2px 12px rgba(0,0,0,0.22)" },
  cardEyebrow: { color: "#15803d", fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase", margin: "0 0 4px" },
  cardTitle: { margin: 0, fontWeight: 700, fontSize: "1.25rem", color: "#f8fafc" },
  primaryBtn: { background: "#10b981", color: "#052e16", border: "none", borderRadius: 8, padding: "10px 20px", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer", fontFamily: "inherit" },
  secondaryBtn: { background: "transparent", border: "1px solid rgba(148,163,184,0.28)", color: "#e2e8f0", borderRadius: 8, padding: "10px 18px", fontWeight: 600, fontSize: "0.85rem", cursor: "pointer", fontFamily: "inherit" },
  jobRow: { background: "rgba(2,6,23,0.6)", border: "1px solid rgba(148,163,184,0.12)", borderRadius: 8, padding: "10px 14px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 },
  tag: { background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.28)", color: "#6ee7b7", borderRadius: 6, padding: "2px 8px", fontSize: "0.72rem", fontWeight: 500, whiteSpace: "nowrap" },
  successIcon: { width: 48, height: 48, background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.28)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" },
  spinner: { width: 36, height: 36, border: "3px solid rgba(148,163,184,0.24)", borderTopColor: "#10b981", borderRadius: "50%", animation: "adm-spin 0.75s linear infinite", margin: "0 auto" },
};
